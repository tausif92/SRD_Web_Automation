*** Variables ***
${Header_Mangalore}                           Mangalore : (Kasargod, Kanhangad)
${PageTitle_Mangalore}                        Mangalore – SRD
...
${City_Value_Mangalore}                       Mangalore
@{Economy_Mangalore}                          Main article: Economy of Mangalore
