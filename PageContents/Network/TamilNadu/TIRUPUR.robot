*** Variables ***
${Header_TIRUPUR}                           Tirupur
${PageTitle_TIRUPUR}                        Tirupur – SRD
${Name_Header_TIRUPUR}                      Name
${Name_Value_TIRUPUR}                       Mr. Noor Basha
${AddressDetails_Header_TIRUPUR}            Address Details
@{AddressDetails_Value_TIRUPUR}             No. 19, Ramaiah Colony,
                                    ...     3rd West Street,
                                    ...     Tirupur - 641 602.
