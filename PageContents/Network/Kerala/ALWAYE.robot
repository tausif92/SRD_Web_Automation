*** Variables ***
${Header_ALWAYE}                           Alwaye
${PageTitle_ALWAYE}                        Alwaye – SRD
${Name_Header_ALWAYE}                      Name
${Name_Value_ALWAYE}                       Mr. Manoj
${AddressDetails_Header_ALWAYE}            Address Details
@{AddressDetails_Value_ALWAYE}             7/67, Chanthakkadavu,
                                    ...     Uliyannoor.P.O,
                                    ...     Aluva 683108.
